...
INSERT INTO `contact` (`id`, `c_name`, `c_phonenumber`, `event_id`) VALUES
(11, 'Dhruvi Jain', 2147483647, 40),
...
(1, 'Aditya', '', 'Shah', '', '', 0, 'aditya.shah_19@sakec.ac.in', 9372622462, 'CS', 'SE', '123', 0, 1, ''),
...
(89, 'c', '', 'c', '', '', 0, 'c@sakec.ac.in ', 3333333333, 'CS', 'FE', '$2y$10$iYbhEjuZ9TQGWnziCVNH1.Q0NzwmuFvFyVDybeEgeLIo8VVNymHu2', 12345, 1, ''),
