...
--
INSERT INTO `aboutus` (`id`, `photo`, `description`)
VALUES (
        1,
        '60d7956a2448e8.30133895.jpg',
...
--
INSERT INTO `collaboration` (`id`, `event_id`, `collab_body`)
VALUES (1, 47, 'computer engineering'),
    (2, 47, 'ieee'),
    (3, 48, 'ieee'),
    (4, 48, 'ipr');
-- --------------------------------------------------------
...
CREATE TABLE `contact` (
    ...
    `c_phonenumber` int(11) NOT NULL,
    `event_id` int(250) NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
--
-- Dumping data for table `contact`
--
INSERT INTO `contact` (`id`, `c_name`, `c_phonenumber`, `event_id`)
VALUES (11, 'Dhruvi Jain', 2147483647, 40),
    (12, 'Pratik Upadhyay', 2147483647, 41),
    (13, 'Bhavya Haria', 2147483647, 42),
    (14, 'Yukta Lapsiya', 2147483647, 43),
    (18, 'xyz', 999999999, 47),
    (19, 'dhiraj', 2147483647, 48),
    (20, 'israil', 99999999, 49);
-- --------------------------------------------------------
--
...
--
INSERT INTO `coordinator` (`id`, `name`, `duty`, `image`)
VALUES (
        1,
        'Dhruvi Jain',
        'GENERAL SECRETARY',
    ...
    (
        7,
        'Rutvik Deshpande',
        'technical team CO-HEAD',
        'Rutvik-dashpande.jpg'
    ),
    (
        8,
        'Ritik Mahajan',
    ...
    (
        9,
        'Ridhi Dagha',
        'REGISTRATION AND TREASURE TEAM treasurer',
        'Ridhhi-dagha.jpeg'
    ),
    (
        10,
        'Shalin Gund',
        'REGISTRATION AND TREASURE TEAM head1',
        'Shalini-gund.jpg'
    ),
    (
        11,
    ...
    (
        15,
        'Bhavika Salshingikar',
        'Design team co-head1',
        'Bhavika-salshingikar.jpg'
    ),
    (
        16,
        'Ritika Boricha',
        'Design team co-head2',
        'Ritika-boricha.jpg'
    );
-- --------------------------------------------------------
--
...
VALUES (
    ...
    (
        ...
        'Introduction with IOT with NODE MCU',
        ' nodemcu.jpg',
        '2019-08-30',
        '2019-08-31',
        '09:00:00',
        '05:00:00',
        'Topics covered were: Introduction to IoT, Basics of NodeMCU, Configuring LEDs with NodeMCU, using different sensors like DHT11, LDRs, IRs & IR-Remote, NodeMCU as a Server & Google Assistant using NodeMCU. ',
        150,
        200,
        1
    ),
    (
        ...
        '06:00:00',
        '06:00:00',
        'On Day 1, We visited Lenze Mechatronics Private Limited. The main parent company is from Germany and all their major operations run from there. We were shown Servo Motors, Gearboxes, AC Drive, PLC, I/O Systems.\nOn Day 2, we visited Vasaya Foods Pvt Ltd which is a company that produces potato chips and snacks.',
        2350,
        2500,
        1
    ),
...
--
INSERT INTO `gallery` (`id`, `image`, `status`)
VALUES (59, 'gal-1.jpg', 1),
    (60, 'gal-2.jpg', 1),
    (61, 'gal-3.jpg', 1),
    (62, 'gal-4.jpg', 1),
    (63, 'gal-5.jpg', 1);
...
VALUES (
        ...
        NULL,
        3232323,
        '60cadefcea89a1.18331541.jpg',
        '60cadefceba240.61221115.jpg',
        '2021-06-24 11:31:17',
        0
    );
-- --------------------------------------------------------
...
--
INSERT INTO `newsletter` (`id`, `emailid`)
VALUES (1, 'aditya.shah_19@sakec.ac.in');
-- --------------------------------------------------------
--
...
--
INSERT INTO `query` (`id`, `c_email`, `c_query`)
VALUES (
        6,
        'israil.alam_19@sakec.ac.in',
...
VALUES (
    ...
    (
        ...
        '',
        0,
        'saivighnesh.shetty_19@sakec.ac.in ',
        999999993,
        'CYBER',
        'TE6',
        '123',
    ...
    (
        ...
        '',
        0,
        'abhishekh.tiwari_19@sakec.ac.in ',
        999999990,
        'IT',
        'SE1',
        '123',
    ...
    (
        ...
        '',
        0,
        'omprateek.shetty_19@sakec.ac.in ',
        999999988,
        'EXTC',
        'BE3',
        '123',
    ...
    (
        ...
        '',
        0,
        'bhuvenshwer.soni_19@sakec.ac.in ',
        999999976,
        'EXTER',
        'BE7',
        '123',
    ...
    (
        ...
        '',
        0,
        'pratik.upadhyay_17@sakec.ac.in',
        9999999999,
        'CS',
        'BE',
        '123',
    ...
    (
        ...
        '',
        0,
        'rutvik.deshpande_19@sakec.ac.in',
        9999999999,
        'CS',
        'SE',
        '123',
    ...
    (
        ...
        '',
        0,
        'bhavika.salshingikar_17@sakec.ac.in',
        9999999999,
        'CS',
        'BE',
        '123',
    ...
    (
        ...
        'CS',
        'FE',
        '$2y$10$iYbhEjuZ9TQGWnziCVNH1.Q0NzwmuFvFyVDybeEgeLIo8VVNymHu2',
        12345,
        1,
        ''
    ),
    (
        ...
        'CS',
        'TE',
        '$2y$10$dt8CQgxhc1AZTHHGOXKblu188qhrcYadG2bmBPYTNdY5hUfaK886S',
        11111,
        6,
        ''
    );
