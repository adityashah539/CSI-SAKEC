...
?>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data" id = "form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                <div class="texts">
                                        <input type="radio" id = "one" name="one" value="1" required="required">
                                        <input type="radio" id = "one" name="one" value="2">                    
                                        <input type="radio" id = "one" name="one" value="3">
                                        <input type="radio" id = "one" name="one" value="4">
                                        <input type="radio" id = "one" name="one" value="5">
                                    </div>
                                </div>
                            </div>
                            <div class="spacer" style="height:20px;"></div>
