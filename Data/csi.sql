...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 15, 2021 at 08:23 PM
...
--
INSERT INTO `csi_aboutus` (`id`, `photo`, `description`)
VALUES (
    1,
    '60e55ac3bcfe36.74441960.jpg',
...
--
INSERT INTO `csi_collaboration` (`id`, `event_id`, `collab_body`)
VALUES (1, 40, 'computer engineering'),
  (2, 47, 'ieee'),
  (3, 48, 'ieee'),
  (4, 48, 'ipr');
-- --------------------------------------------------------
...
VALUES (11, 'Dhruvi Jain', 2147483647, 40, 0),
...
--
INSERT INTO `csi_contentrepository` (`id`, `eventid`, `image`)
VALUES (17, 40, '60c5e787b52877.83501876.jpeg'),
...
--
INSERT INTO `csi_gallery` (`id`, `image`, `status`)
...
VALUES (11, 90, NULL, '', NULL, NULL, 0, NULL);
-- --------------------------------------------------------
--
...
--
INSERT INTO `csi_newsletter` (`id`, `emailid`, `vKey`, `status`)
VALUES (1, 'aditya.shah_19@sakec.ac.in', '', 0),
  (
    4,
    'dhirajshetty91@yahoo.com',
    'd283254e5f77cd901791fcc03b3f64f8',
    0
  ),
  (
    6,
    'saivignesh.adepu_19@sakec.ac.in',
    'c10c2574aab1d83b0d67c0258e8ce4b1',
    0
  ),
  (
    8,
    'rahul.soni_19@sakec.ac.in',
    '4aa1f530a47d879a4db718fdf10aff8a',
    1
  );
-- --------------------------------------------------------
--
...
--
INSERT INTO `csi_query` (`id`, `c_email`, `c_query`)
VALUES (
    6,
...
--
INSERT INTO `csi_role` (`id`, `role_name`)
VALUES (1, 'admin'),
  (2, 'head coordinator'),
  (3, 'coordinator'),
  (4, 'teacher'),
  ...
  (6, 'student'),
  (8, 'General Secretary'),
  (9, 'Student Coordinator'),
  (10, 'General Coordinator'),
  (11, 'Event Team Head'),
  (12, 'Event Team Co-Head'),
  (13, 'Technical Team Head'),
  (14, 'Technical Team Co-Head'),
  (15, 'Design Team Head'),
  (16, 'Design Team Co-Head'),
  (17, 'Registration & Treasure Team Head'),
  (18, 'Registration & Treasure Team Co-Head'),
  (19, 'Documentation Team Head'),
  (20, 'Documentation Team Co-Head'),
  (21, 'Social Media Team Head'),
  (22, 'Social Media Team Co-Head'),
  (23, 'Website Team Head'),
  (24, 'Website Team Co-Head');
-- --------------------------------------------------------
--
...
VALUES (
    ...
    'developer',
    'abc',
    '60d1c3dd095b22.38584146.jpg',
    'https://www.linkedin.com/in/aditya-shah539/'
  ),
  (
    2,
    48,
    ...
    'www.linkedin.com/in/aditya-shah539'
  ),
  (
    3,
    48,
...
VALUES (
  ...
  (
    ...
    8779633138,
    'CS',
    '$2y$10$3BzXbe.vE6VmocyQlJUGMOV1TcchPwrqWzG1zuWuRb8dOZE5BKbFi',
    6,
    'male'
  );
-- --------------------------------------------------------
...
--
INSERT INTO `csi_venue` (`id`, `event_id`, `location`)
VALUES (1, 47, '4th-Floor Seminar Hall');
--
...
--
ALTER TABLE `csi_userdata`
ADD CONSTRAINT `userdata_ibfk_1` FOREIGN KEY (`role`) REFERENCES `csi_role` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
--
