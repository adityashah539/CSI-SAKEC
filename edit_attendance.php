                ...
                <form action="" method="post">
                    ...
                    if (isset($_SESSION['email'])) {
                        if ($_SESSION['role'] === 'admin') {
                            $sql = "SELECT CONCAT(`userdata`.`firstName`,' ', `userdata`.`lastName`) as `name`,`userdata`.`emailID`,`attend`,`userdata`.`id`
                                    ...
                                    (LOWER(CONCAT(`userdata`.`firstName`,' ', `userdata`.`lastName`)) LIKE '%$to_search%' OR LOWER(`emailID`) LIKE '%$to_search%')";
                            //echo $sql;
