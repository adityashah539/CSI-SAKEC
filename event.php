...
<body>
  ...
  ?>
    ...
    <div class="container ">
      ...
      <div class="spacer" style="height:20px;"></div>
      <?php echo $row['banner'];?>
      <img class="main-img" src="images/<?php echo $row['banner'];?>" alt="">
      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <div class="know-more">
            ...
            <div class="spacer" style="height:20px;"></div>
            <p>CSI Members – Rs.<?php echo $row['fee_m'];?><br>
              Non-CSI Members – Rs.<?php echo $row['fee'];?></p>
          ...
          <div class="speakers">
            ...
            <div class="card card-cascade">
              ...
              <div class="view view-cascade overlay">
                <img class="card-img-top" src="images/<?php echo $row['s_photo'];?>" alt="Card image cap">
                <a>
